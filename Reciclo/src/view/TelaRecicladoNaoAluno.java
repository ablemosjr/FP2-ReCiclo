 ...
 * @author suporte
 */
public class TelaRecicladoNaoAluno extends javax.swing.JFrame {

    /**
     * Creates new form TelaRecicladoNaoAluno
     */
    public TelaRecicladoNaoAluno() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblSucesso1 = new javax.swing.JLabel();
        ...
        lblSucesso.setText("O mundo agradece :)");
        jPanel1.add(lblSucesso, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 580, -1, -1));
        ...
        lblSucesso1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        lblSucesso1.setForeground(new java.awt.Color(160, 205, 96));
        lblSucesso1.setText("com sucesso!");
        jPanel1.add(lblSucesso1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRecicladoNaoAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRecicladoNaoAluno().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblSucesso1;
