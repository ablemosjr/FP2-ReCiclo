...
public class TextFieldSuggestionUI extends MetalTextFieldUI {
    ...
    public TextFieldSuggestionUI(JTextField textfield) {
        ...
        textfield.setSelectionColor(new Color(160,205,96));
        textfield.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(160,205,96));
                textfield.repaint();
            }

            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(206,240,157));
                textfield.repaint();
            }
        });
    }
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(160,205,96);
        private Color color = new Color(206,240,157);
        private int round;
